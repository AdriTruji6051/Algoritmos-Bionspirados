...
class Graph_Configuration:
    def __init__(self):
        ...
        self.food_in_objective = 100000000000000000
        self.pheromones = 1000000000000000000000
        self.evaporation_rate = 1
        self.pheromonesEdgesMap = {}
        self.imp_Pheromones = 0.9
...
#HELP FUNCTIONS TO WORK WITH NETWORKX LIB
    ...
    def getEdgePheromones(self, ori_node, dest_node):
        ...
        else: return self.graph_configuration.pheromones * 0.001
...
#MATH FUCNTIONS TO OUR COLONY    
    ...
    def calcProbNode(self, ant):
        possible_nodes = self.getPossibleNodes(ant)
        ...
        for node in possible_nodes:
            ...
            for knode in possible_nodes:   
                if knode != node: 
                    ...
                    Tik = self.getEdgePheromones(ant.path[-1], knode)
                    ik +=  ( (Tik ** self.graph_configuration.imp_Pheromones)) * (Nik ** self.graph_configuration.imp_Node_Vis)

            Tij = self.getEdgePheromones(ant.path[-1], node)
            ...
            nodes_probability.append([node, (ij / ik)])    
...
#MAIN HELP FUNCTIONS  
    def goToFitnessNode(self, ant):
        ...
        if next_node != None:
            #ant.edgesVis.update([ant.path[-1],next_node])
...
#OFICIAL MAIN FUNCTIONS   
    ...
    def showAntsPaths(self):
        ...
        print(self.graph_configuration.pheromonesEdgesMap)